...
namespace Evade
{
    internal static class Config
    {
        ...
        public static void CreateMenu()
        {
            ...
            Menu.AddItem(
                new MenuItem("Enabled", "Enabled").SetValue(new KeyBind(35, KeyBindType.Toggle, true)));

            Menu.AddItem(
                new MenuItem("OnlyDangerous", "Dodge only dangerous").SetValue(new KeyBind("N".ToCharArray()[0], KeyBindType.Press)));
