    ...
    internal class DetectedWard
    {
        ...
        public void CreateRenderObjects()
        {
            ...
            _defaultCircle.VisibleCondition +=
                sender =>
                    Program.Menu.Item("Enabled").GetValue<bool>() &&
                    !Program.Menu.Item("Details").GetValue<KeyBind>().Active && Render.OnScreen(Drawing.WorldToScreen(Position));
            ...
            _rangeCircle.VisibleCondition +=
                sender =>
                    Program.Menu.Item("Enabled").GetValue<bool>() &&
                    Program.Menu.Item("Details").GetValue<KeyBind>().Active;
            _rangeCircle.Add(0);
            ...
            if (Duration != int.MaxValue)
            {
                ...
                _timerText.VisibleCondition += sender => Program.Menu.Item("Enabled").GetValue<bool>() && Render.OnScreen(Drawing.WorldToScreen(Position));
