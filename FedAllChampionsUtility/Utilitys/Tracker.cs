    ...
    internal class Tracker
    {
        ...
        private static void Drawing_OnDraw(EventArgs args)
        {
            ...
            try
            {
                ...
                .Where(hero => hero != null && hero.IsValid && hero.IsHPBarRendered && (hero.IsEnemy && Program.Menu.Item("tb_show_enemy").GetValue<bool>() || !hero.IsMe && hero.IsAlly && Program.Menu.Item("tb_show_friend").GetValue<bool>() || hero.IsMe && Program.Menu.Item("tb_show_me").GetValue<bool>())))
                {
                    Sprite.Begin();
